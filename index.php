...
<body>
    <div class="wrapper">
        <header class="header">
            ...
            <div class="header__row">
                <div class="header-logo">
                    <img class="header-logo__img" src="logo.png" alt="" >
                    <h4 class="header-logo__text">Privacy e termini</h4>
                </div>
            ...
            <nav class="nav">
                <ul class="nav__ul">
                    <li class="nav__li">Introduzione</li>
                    <li class="nav__li">Norme sulla privacy</li>
                    <li class="nav__li">Termini di servizio</li>
                    <li class="nav__li">Tecnologie</li>
                    <li class="nav__li active">Domande frequenti</li>
                </ul>
            </nav>
        </header>
        ...
        <main class="main">
            <div class="container">
            <?php
                $test = map($data,  function($userProfile)
                {
            ?>        
                <h3><?php echo $userProfile['quest'] ?></h3>
                <p class="text"><?php echo $userProfile['answ'] ?></p>
